...
const ForgotPasswordPage: React.FC = () => {
  ...
  const inputStyle =
    'w-full px-4 py-3 bg-[#2a2a2a] text-white border border-[#DAA520]/40 rounded-lg focus:ring-2 focus:ring-[#DAA520] focus:border-transparent placeholder-gray-400';
  ...
  const renderEmailStep = () => (
    <div className={cardStyle}>
      <div className="text-center mb-8">
        <div className="bg-[#DAA520]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
          <Mail className="w-8 h-8 text-[#DAA520]" />
        </div>
        <h1 className="text-3xl font-bold text-[#DAA520]">Forgot Password?</h1>
        <p className="text-gray-400 mt-2">Enter your email to receive an OTP</p>
      </div>
      ...
      <div className="mt-6 text-center">
        <Link to="/auth/login" className="inline-flex items-center text-gray-400 hover:text-[#DAA520]">
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Login
        </Link>
      </div>
  ...
  const renderOtpStep = () => (
    <div className={cardStyle}>
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-[#DAA520]">Enter OTP</h1>
      ...
      <form onSubmit={handleOtpSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            value={otp}
            onChange={(e) => setOtp(e.target.value)}
            className={`${inputStyle} text-center text-lg tracking-widest`}
            placeholder="Enter 6-digit code"
            maxLength={6}
            required
          />
      ...
      <div className="mt-6 text-center">
        <button onClick={() => setStep('email')} className="text-gray-400 hover:text-[#DAA520]">
          Didn't receive the code? Try again
        </button>
      </div>
    </div>
  ...
  const renderResetStep = () => (
    <div className={cardStyle}>
      <div className="text-center mb-8">
        <div className="bg-[#DAA520]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
          <Key className="w-8 h-8 text-[#DAA520]" />
        </div>
        <h1 className="text-3xl font-bold text-[#DAA520]">Reset Password</h1>
      ...
      <div className="mt-6 text-center">
        <Link to="/auth/login" className="text-gray-400 hover:text-[#DAA520]">
          Back to Login
        </Link>
      </div>
    </div>
